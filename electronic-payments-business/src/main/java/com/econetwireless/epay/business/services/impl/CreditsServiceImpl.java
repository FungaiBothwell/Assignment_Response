...
public class CreditsServiceImpl implements CreditsService{
    ...
    public AirtimeTopupResponse credit(final AirtimeTopupRequest airtimeTopupRequest) {
        ...
        changeSubscriberRequestStatusOnCredit(subscriberRequest, inCreditResponse);
    ...
    private  void changeSubscriberRequestStatusOnCredit(final SubscriberRequest subscriberRequest, final INCreditResponse inCreditResponse) {
